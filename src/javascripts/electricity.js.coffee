class Electricity
  ...
  setup: () ->
    ...
    $('#display').append("<h5>Explore</h5><ul class='subnav'><li><a href='#' id='energy-subnav-1' class='selected' onclick='twentyfifty.switchView(\"electricity\")'>Electricity Demand and Supply</a></li><li style='display:none'><a href='#' id='energy-subnav-2' class='' onclick='twentyfifty.switchView(\"electricity_analysis\")'>Analysis of Electricity Share</a></li><li style='display:none'><a href='#' id='energy-subnav-3' class='' onclick=''>Electricity 3</a></li></ul>")
